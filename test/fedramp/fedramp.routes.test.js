describe('Fedramp routing', function(){
	...
	it('can access all routes', function () {
        var routes = [
            ...
            { url: '/providers', state: 'fedramp.app.home.providers'},
            ...
            { url: '/provider/acme', state: 'fedramp.app.provider.information'},
            { url: '/provider/acme/versus/xyz', state: 'fedramp.app.provider.comparison'},
