...
.constant('dataUrl','https://raw.githubusercontent.com/18F/fedramp-data/new-schema/data/data.json').run(run);run.$inject=['$log'];function run($log){$log.debug('fedramp.services module initializing');}})();/**
