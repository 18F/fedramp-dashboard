...
property:'@',placeholder:'@'}});GridSearch.$inject=['Searcher'];/**
     ...
     * @constructor
     * @memberof Components
     */function GridSearch(Searcher){var self=this;var searcher=new Searcher();self.filtered=[];self.$onInit=$onInit;self.search=search;self.doFilter=doFilter;function $onInit(){self.gridController.addFilter(self);}/**
         * Filter applied to dataset when user searches
         */function doFilter(obj,index,arr){if(self.searchTerm){var found=searcher.prop(self.property).contains(obj,self.searchTerm);if(found.length>0){return obj;}else{return null;}}else{return obj;}}/**
