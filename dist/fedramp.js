...
.state('fedramp.app.home.assessors',{url:'/assessors',templateUrl:'src/templates/home/assessors.html',controller:'AssessorsController as controller',resolve:{assessors:['fedrampData',function(fedrampData){return fedrampData.assessors();}]}}).state('fedramp.app.assessor',{url:'/assessor',templateUrl:'src/templates/home/assessor.html'}).state('fedramp.app.assessor.information',{url:'/:name',templateUrl:'src/templates/home/assessor-information.html',controller:'AssessorInformationController as controller'}).state('fedramp.app.assessor.comparison',{url:'/:first/versus/:second',templateUrl:'src/templates/home/assessor-comparison.html',controller:'AssessorComparisonController as controller'});}})();(function(){'use strict';angular.module('fedramp.components').component('agenciesGrid',{templateUrl:'src/templates/components/agencies-grid.html',controller:AgenciesGrid,controllerAs:'controller',bindings:{expandTiles:'<',rawItems:'<?',onUpdate:'&?'}});AgenciesGrid.$inject=['$log','fedrampData','$attrs'];/**
     ...
     */function Assessor($log,$state,helperService){var self=this;/**
         ...
         */self.markdown=function(text){return $sce.trustAsHtml(new showdown.Converter().makeHtml(text));};}})();(function(){'use strict';angular.module('fedramp.components').component('assessorsGrid',{templateUrl:'src/templates/components/assessors-grid.html',controller:AssessorGrid,controllerAs:'controller',bindings:{expandTiles:'<',rawItems:'<?',onUpdate:'&?'}});AssessorGrid.$inject=['$log','fedrampData','$attrs'];/**
     * @constructor
     * @memberof Components
...
sortedProductKeys=sortedProductKeys.map(function(v){return{name:v,products:products[v]};});self.groupedProducts=sortedProductKeys;}/**
     ...
     */function Product($log,$state,helperService){var self=this;/**
         ...
         * @returns
         *  Status message
         */self.statusMessage=function(){var message='';if(self.isCompliant()){message='Compliant Since '+(self.model.authorizationDate||'');}else{if(self.model.expectedCompliance){message='Estimated Compliance Date '+self.model.expectedCompliance;}else{message='This provider has not given an Estimated Compliance Date';}}return message;};/**
         * Parses possible markdown, or other encoded text, as HTML
         * @public
         * @memberof Components.Product
         *
         ...
         * @returns
         *  The text in HTML format
         */self.markdown=function(text){return $sce.trustAsHtml(new showdown.Converter().makeHtml(text));};}})();(function(){'use strict';angular.module('fedramp.components').component('productsGrid',{templateUrl:'src/templates/components/products-grid.html',controller:ProductsGrid,controllerAs:'controller',bindings:{expandTiles:'<',rawItems:'<?',onUpdate:'&?'}});ProductsGrid.$inject=['$log','fedrampData','$attrs'];/**
     * @constructor
     * @memberof Components
...
var self=this;/**
             ...
             * @member {string}
             * @memberof Models.Assessor
             */self.description='';}return Assessor;}})();(function(){'use strict';angular.module('fedramp.models').factory('AtoLetter',AtoLetterFactory);function AtoLetterFactory(){return AtoLetter;}/**
...
var self=this;/**
             ...
             * @member {string}
             * @memberof Models.Product
             */self.serviceDescription='';}return Product;}})();(function(){'use strict';angular.module('fedramp.models').factory('Provider',ProviderFactory);ProviderFactory.$inject=[];function ProviderFactory(){/**
