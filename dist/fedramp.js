...
var STATE_REGEX=/^fedramp.app.(?!home)/g;/**
         ...
         */$rootScope.$on('$stateChangeStart',function(event,toState,toParams,fromState,fromParams,options){params=$location.search();routeOptions=options;console.log(options);});$rootScope.$on('$stateChangeSuccess',function(event,toState,toParams,fromState,fromParams,options){// Enable routes to pass a underlying queryParams object that we can populate
