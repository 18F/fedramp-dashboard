...
var self=this;var mapping={'Created_At':'lastRefresh','Produced_By':'producedBy'};/**
         ...
         */function today(date){var d=date;var dd=d.getDate();var mm=d.getMonth()+1;var yyyy=d.getFullYear();if(dd<10){dd='0'+dd;}if(mm<10){mm='0'+mm;}return mm+'/'+dd+'/'+yyyy;}return self.init(options);}})();(function(){'use strict';angular.module('fedramp.components').component('agenciesGrid',{templateUrl:'src/templates/components/agencies-grid.html',controller:AgenciesGrid,controllerAs:'controller',bindings:{rawItems:'<?',onUpdate:'&?'}});AgenciesGrid.$inject=['$log','fedrampData','$attrs'];/**
     * @constructor
     * @memberof Components
...
if(navigator.msSaveBlob&&downloadBlob){navigator.msSaveBlob(downloadBlob,self.filename());}}/**
     ...
     */function GridFilterClear(){var self=this;self.clear=clear;/**
         ...
         * @public
         * @memberof Components
         */function clear(){self.gridController.clearFilters();}}})();(function(){'use strict';/**
     ...
     */angular.module('fedramp.components').component('gridFilterPrint',{controllerAs:'controller',templateUrl:'src/templates/components/grid-filter-print.html',require:{gridController:'^grid'}});})();(function(){'use strict';angular.module('fedramp.components').component('gridFilter',{controller:GridFilter,controllerAs:'controller',templateUrl:'src/templates/components/grid-filter.html',require:{// We require that this component live inside of <grid></grid> so it can
