...
if(self.activeSort){combinedFilterResults.sort(self.activeSort.sortFunc);}self.items=combinedFilterResults;self.doUpdate();}/**
         ...
         */function doUpdate(){if(self.saveState){$location.search(self.state);}self.onUpdate({items:self.items,state:self.state});}}})();(function(){'use strict';angular.module('fedramp.components')/**
         * @example
         *
         * @constructor
         * @memberof Components 
         */.component('menu',{templateUrl:'src/templates/components/menu.html',controller:MenuController,controllerAs:'controller'});MenuController.$inject=['$state'];/**
