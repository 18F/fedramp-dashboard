...
if(Object.keys(rawAssessors[x]).length===0){continue;}var assessorData=new AssessorData(rawAssessors[x]);if(safeTrim(assessorData.name)===safeTrim(assessor.name)){assessor.accreditationDate=helperService.toDate(assessorData.accreditationDate);break;}}return assessor;}return self.init(options);}StorageData.prototype=Object.create(StorageManager.prototype);StorageData.prototype.constructor=StorageData;return StorageData;}})();(function(){'use strict';angular.module('fedramp.services').factory('StorageManager',StorageManagerFactory);function StorageManagerFactory(){return StorageManager;}/**
...
var self=this;/**
             ...
             * @member {array}
             * @memberof Models.Agency
             */self.assessors=[];}return Agency;}})();(function(){'use strict';angular.module('fedramp.models').factory('AssessorData',AssessorDataFactory);AssessorDataFactory.$inject=[];function AssessorDataFactory(){return AssessorData;/**
...
var self=this;/**
             ...
             * @member {string}
             * @memberof Models.Assessor
             */self.accreditationDate='';}return Assessor;}})();(function(){'use strict';angular.module('fedramp.models').factory('AtoLetter',AtoLetterFactory);function AtoLetterFactory(){return AtoLetter;}/**
...
if(response&&response.data){if(response.data.results){self.results=response.data.results;}}},function(response){self.error=true;});})();}})();(function(){'use strict';angular.module('fedramp').controller('AgenciesController',AgenciesController);AgenciesController.$inject=['$log','agencies'];/**
     ...
     */function AssessorsController($log,assessors){var self=this;/**
         ...
         * @returns
         *  The matched item or null
         */self.reuseRangeFilter=function(assessor,index,arr,selectedOptions){return selectedOptions.find(function(option){if(assessor.reuses>=option.value.min&&assessor.reuses<=option.value.max){return option;}});};}})();(function(){'use strict';angular.module('fedramp').controller('HomeController',HomeController);HomeController.$inject=['$log','fedrampData','CsvService','Cache'];/**
     * @constructor
     * @memberof Controllers
     */function HomeController($log,fedrampData,CsvService,Cache){var self=this;/**
...
if(navigator.msSaveBlob&&downloadBlob){navigator.msSaveBlob(downloadBlob,self.filename());}};/**
         ...
         */self.totalAuthorized=Cache.wrap('totalAuthorized')(function(){return fedrampData.products().filter(function(x){return x.designation!=='In-Process';}).length;});/**
         ...
         */self.totalReady=Cache.wrap('totalReady')(function(){return 0;});}})();(function(){'use strict';angular.module('fedramp').controller('ProductComparisonController',ProductComparisonController);ProductComparisonController.$inject=['$log','$state','$stateParams','fedrampData','helperService'];/**
     * @constructor
     * @memberof Controllers
