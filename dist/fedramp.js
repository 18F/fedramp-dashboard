...
if(self.activeSort){combinedFilterResults.sort(self.activeSort.sortFunc);}self.items=combinedFilterResults;self.doUpdate();}/**
         ...
         */function doUpdate(){if(self.saveState){$location.search(self.state);}self.onUpdate({items:self.items,state:self.state});}}})();(function(){'use strict';angular.module('fedramp.components').component('navigation',{templateUrl:'src/templates/components/navigation.html',controller:Navigation,controllerAs:'controller'});Navigation.$inject=[];/**
     * @constructor
     * @memberof Components
     * @example <navigation />
